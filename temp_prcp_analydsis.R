...
plot(ts_ts(historical$MAX_SI),
  col = "darkred", bty = "n", las = 1, fg = NA,
...
barplot(historical$PRCP_SI,
  border = NA, col = "lightgreen", ylim = c(0, 2),
...
plot(ts_ts(monthly.tmax),
  col = "darkred", ylim = c(20, 100),
...
plot(NA,
  xlim = range(indices), ylim = c(-20, 100),
